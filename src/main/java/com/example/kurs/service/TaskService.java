...
public class TaskService {
    ...
    public Task update(Long id, TaskRequestDto task){
        ...
        newTask.setCreatorPostId(task.getCreatorPostId() != null ? task.getCreatorPostId() : origin.getCreatorPostId());
        newTask.setExecutorPostId(task.getExecutorPostId() != null ? task.getExecutorPostId() : origin.getExecutorPostId());
        newTask.setId(id);
